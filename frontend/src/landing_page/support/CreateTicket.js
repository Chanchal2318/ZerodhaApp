        ...
        <>
          <div className="container">
            <div className="row mt-5">
              ...
              <div className="col-4  ">
                <h3 className='mt-5 mb-5' style={{textAlign:"left"}}><i class='fa fa-plus-circle ' aria-hidden='true'></i> Account Opening</h3>
                ...
                <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Zerodha IDFC FIRST Bank 3-in-1 Acount</a><br/>
                <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Getting Started</a><br/>
              </div>
              <div className="col-4">
              <h3 className='mt-5 mb-5' style={{textAlign:"left"}}><i class="fa fa-user" aria-hidden="true"></i> Your Zerodha Account</h3>
              ...
              <div className="col-4  ">
                <h3 className='mt-5 mb-5' style={{textAlign:"left"}}><i class="fa fa-bar-chart" aria-hidden="true"></i> Your Zerodha Account</h3>
                ...
                <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}>Senitel</a><br/>
              ...
              <div className="row">
                <div className="col-4">
                <h3 className='mt-5 mb-5' style={{textAlign:"left"}}><i class="fa fa-credit-card-alt" aria-hidden="true"></i> Funds</h3>
                ...
                <div className="col-4">
                <h3 className='mt-5 mb-5' style={{textAlign:"left"}}><i class="fa fa-circle-o-notch" aria-hidden="true"></i> Console</h3>
                ...
                <div className="col-4">
                <h3 className='mt-5 mb-5' style={{textAlign:"left"}}><i class="fa fa-circle-thin" aria-hidden="true"></i> Coin</h3>
